...
const Details = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://api.mapbox.com/geocoding/v5/mapbox.places/${point.long},${point.lat}.json`,
        {
          params: {
          ...
          <div className="info-card full-page ml-3">
            <div className="card-body">
              ...
              <div className="px-3 pt-1 pb-1 type-title">
                ...
                <span>
                  {moment(props.data.timestamp).format("MMMM D, YYYY")} (
                  ...
                  <div className="mt-1">
                    <div className="event-flow">
                      ...
                      <div>
                        ...
                        <div className="event-block">
                          <div
                            className={`reportee-profile flow-result ${props.data.status}`}
                          >
                            {!localStorage.user ? (
                              <div className="skeleton-cards">
                                <div className="skeleton-card info-card-loader">
